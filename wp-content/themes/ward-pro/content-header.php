...
$icon = array( 'audio' => 'fa-music', 'video' => 'fa-film', '0' => 'fa-file-o', 'gallery' => 'fa-camera-retro', 'image' => 'fa-picture-o', 'chat' => 'fa-bullhorn' );
$display_categories = $bavotasan_theme_options['display_categories'];

	if ( ! empty( $display_categories ) && 'page' != get_post_type() ) { ?>
	<h3 class="post-category"><i class="fa <?php echo $icon[$format]; ?>"></i><?php the_category( ', ' ); ?></h3>
	<?php } ?>
